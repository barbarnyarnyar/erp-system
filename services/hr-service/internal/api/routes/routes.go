...
func RegisterRoutes(
	...
	v1 := r.Group("/api/v1")
	{
		...
		v1.PUT("/employees/:id/compensation", empHandler.UpdateCompensation)
		v1.GET("/employees/:id/position-history", empHandler.GetPositionHistory)
		v1.GET("/employees/:id/department-history", empHandler.GetDepartmentHistory)
		v1.GET("/employees/:id/compensation-history", empHandler.GetCompensationHistory)
